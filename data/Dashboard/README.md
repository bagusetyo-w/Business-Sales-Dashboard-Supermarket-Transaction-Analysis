...
- **Key Performance Indicators (KPI)**  
  Total Penjualan, Total Transaksi, Total Quantity, dan Rata-rata Penjualan
- **Tren Penjualan**  
  Perkembangan penjualan berdasarkan waktu (harian/bulanan)
- **Penjualan per Produk dan Kategori**  
  Analisis produk dan kategori dengan performa penjualan tertinggi
- **Penjualan per Cabang / Store**  
  Perbandingan performa antar cabang supermarket
- **Metode Pembayaran dan Channel Penjualan**  
